...
var routes = function ($routeProvider, $locationProvider) {
  ...
  .when('/timeseries/:id/edit', {
    templateUrl: 'timeseries/timeseries-edit.html', controller: 'TimeseriesEditController'
  })
  .when('/timeseries/:id', {
    redirectTo: '/timeseries/:id/edit'
  })
  .when('/timeseries', {
    templateUrl: 'timeseries/timeseries-search.html', controller: 'TimeseriesSearchController'
  })
  ...
  .when('/', {
    templateUrl: 'indicator/indicator-search.html', controller: 'IndicatorSearchController'
  })
  .when('/:id/show', {
    redirectTo: '/:id'
  })
  .when('/:id', {
    templateUrl: 'indicator/indicator-show.html', controller: 'IndicatorShowController'
  })
  .when('/:id/edit', {
    templateUrl: 'indicator/indicator-edit.html', controller: 'IndicatorEditController'
  });
