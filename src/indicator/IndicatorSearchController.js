 ...
 * @ngInject
 */
var IndicatorSearchController = function($scope, $location, $controller, npdcAppConfig, NpolarApiSecurity, NpolarTranslate, Indicator) {
  ...
  $scope.T = NpolarTranslate;
   npdcAppConfig.cardTitle = 'Environmental monitoring';
    ...
    let query = { start: 0, limit: 1000, "size-facet": 5, format: "json",  
